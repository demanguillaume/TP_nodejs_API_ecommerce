...
const validateUserRegistration = (requireUserRole = false) => [
    ...
    ...(requireUserRole ? [(0, express_validator_1.check)('UserRole').isIn(Object.values(User_1.UserRole))] : []),
    (req, res, next) => {
        const errors = (0, express_validator_1.validationResult)(req);
        if (!errors.isEmpty()) {
            next(new ResponseError_1.ResponseError(400, JSON.stringify(errors.array()), 'Validation Error : ' + JSON.stringify(errors.array())));
        }
        next();
    },
];
