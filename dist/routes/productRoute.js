...
router.post(
  ...
  (0, sendJsonResponse_1.sendJsonResponse)('product'),
);
// READ ALL /product
router.get(
  '/',
  ...
  (0, sendJsonResponse_1.sendJsonResponse)('products'),
);
...
router.patch(
  ...
  productController_1.updateProductById,
  (0, sendJsonResponse_1.sendJsonResponse)('product'),
);
// DELETE /product/:id
router.delete(
  ...
  productController_1.deleteProductById,
