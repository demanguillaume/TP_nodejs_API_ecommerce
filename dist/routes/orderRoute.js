...
router.post(
  '/',
  (0, authorizeByRole_1.authorizeByRole)([
    User_1.UserRole.USER,
    User_1.UserRole.MANAGER,
    User_1.UserRole.ADMIN,
  ]),
  validateOrderDatas_1.validateOrderDatas,
  checkDuplicateProductIds_1.checkDuplicateProductIds,
  orderController_1.createOrder,
  (0, sendJsonResponse_1.sendJsonResponse)('order'),
);
// READ ALL /order
router.get(
  '/',
  ...
  (0, sendJsonResponse_1.sendJsonResponse)('orders'),
);
// READ BY ID /order/:id
router.get(
  '/:id',
...
router.patch(
  ...
  orderController_1.getOrderById,
  verifyOrderOwnership_1.verifyOrderOwnership,
  orderController_1.updateOrderById,
  (0, sendJsonResponse_1.sendJsonResponse)('order'),
);
...
router.delete(
  ...
  orderController_1.getOrderById,
  verifyOrderOwnership_1.verifyOrderOwnership,
  orderController_1.deleteOrderById,
  (0, sendJsonResponse_1.sendJsonResponse)('message'),
);
