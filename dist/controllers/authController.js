...
const registerUser = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      next(
        new ResponseError_1.ResponseError(500, 'Internal Server Error', error),
      );
    }
  });
...
const loginUser = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      if (!user) {
        const responseError = new ResponseError_1.ResponseError(
          401,
          'User not found',
        );
      ...
      // Generate a JWT token
      const token = (0, jsonwebtoken_1.sign)({ userId: user.id }, jwtSecret, {
        expiresIn: '1h',
      });
      // Set the status and locals for the response
      res.statusCode = 200;
